  ...
  >
      ...
      <div class="container mx-auto px-4 md:px-6 py-6 md:py-8">
        ...
        >
          <div class="text-center md:text-right">
            <h3 class="text-base md:text-lg font-bold mb-2">اشترك في النشرة الإخبارية</h3>
            <p class="text-white/80 text-xs md:text-sm">احصل على أحدث العروض والأخبار</p>
          </div>
          ...
          <div class="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
            <input
              ...
              class="flex-1 md:w-64 px-3 md:px-4 py-2 rounded-full bg-white/10 border border-white/20 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent text-sm md:text-base"
            />
            <button
              class="px-4 md:px-6 py-2 bg-secondary hover:bg-secondary/90 rounded-full font-medium transition-colors duration-300 flex items-center gap-2 text-sm md:text-base justify-center"
            >
              <Icon name="mdi:send" class="text-sm md:text-base" />
              اشتراك
            </button>
          </div>
        </div>
    ...
    <div class="border-t border-white/10 bg-black/20">
      <div class="container mx-auto px-4 md:px-6 py-4 md:py-6">
        <div
          class="flex flex-col md:flex-row items-center justify-between gap-3 md:gap-4"
        >
