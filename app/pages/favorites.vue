	...
	<div class="min-h-screen bg-neutral-50 dark:bg-zinc-950">
		...
		<div class="container mx-auto px-6 py-16">
			...
			<div v-if="loading" class="flex justify-center py-20">
				<div class="relative">
					<div
						class="w-20 h-20 rounded-full border-4 border-purple-200 dark:border-purple-900 border-t-purple-600 dark:border-t-purple-400 animate-spin"
					></div>
					<Icon
						name="solar:heart-bold"
						class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-3xl text-purple-600 dark:text-purple-400 animate-pulse"
					/>
				</div>
			</div>
			...
			<div v-else-if="favoriteHotels.length === 0" class="py-20">
				<div class="max-w-2xl mx-auto text-center">
					<div class="relative inline-block mb-8">
						<div
							class="absolute inset-0 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full blur-2xl opacity-20"
						></div>
						<div
							class="relative p-8 rounded-full bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 border border-purple-200 dark:border-purple-700 aspect-square"
						>
							<Icon
								name="solar:heart-broken-bold"
								class="text-6xl text-purple-600 dark:text-purple-400 block"
							/>
						</div>
					</div>
			...
			<div v-else>
					...
					>
						<div>
							...
							<p class="text-gray-600 dark:text-gray-400">
								{{ $t("favorites.showing") }} {{ favoriteHotels.length }}
								{{ $t("favorites.hotels_count") }}
							</p>
						</div>
				...
				<section class="text-center">
					<div
						class="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-3xl p-12 border border-purple-200 dark:border-purple-700"
					>
